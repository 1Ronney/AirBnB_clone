#!/usr/bin/python3
"""Unittest defination for console.py
Unittetst classes:
...
class TestHBNBCommand_prompting(unittest.TestCase):
    """unittest for prompting the HBNB command interpreter."""
    ...
    def tearDownClass(self):
        """remove temporary file(file.json) creation as output"""
        try:
            os.remove("file.json")
    ...
    def test_pep8_console(self):
        ...
        errors = 0
        file = (["console.py"])
        errors += style.checkfiles(file).total_errors
        self.assertEqual(error, 0, 'Must fix Pep8')
    ...
    def test_pep8_test_console(self):
        ...
        self.assertEqual(errors, 0, 'Must fix Pep8')

    def test_pep8_test_console(self):
        """test docstring existing in console.py"""
        self.assertTrue(len(console.__doc__) >= 1)

    def test_docstrings_in_test_console(self):
        """test docstring present in test_console,py"""
        self.assertTrue(len(self.__doc__) >= 1)

    def test_prompt_string(self):
        self.asserEqual("(hbnb) ", HBNBCommand.prompt)
